/*
 * M1Shield Simple Screen Example
 *
 * Basic screen with button handling and LED control.
...
void setup()
{
    ...
    M1Shield.setScreen(new SimpleScreen());
...
void loop()
{
    ...
    // Seriously, that's it! The magic happens in SimpleScreen.cpp
}
